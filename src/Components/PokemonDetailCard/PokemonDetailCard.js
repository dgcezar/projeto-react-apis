...
function PokemonDetailCard(props) {
  ...
  return (
    <>
      <PokemonDetailDescriptionContainer>
        <PokemonDetailLeftContainer>
          <PokemonDetailImage><img src={pokemonDetail.sprites?.front_default} /></PokemonDetailImage>
          <PokemonDetailImage><img src={pokemonDetail.sprites?.back_default} /></PokemonDetailImage>          
        ...
        <PokemonDetailRightContainer>
          ...
          <PokemonDetailMovesContainer><h3>Moves:</h3>
          {pokemonDetail.moves?.map((mov, index) => 
            index < 4 && (
